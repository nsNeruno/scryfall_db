...
class _ConditionalFormatImpl implements ConditionalFormat {
  ...
  set topBorderColor(String value) {
    ...
    _topBorderColorRgb = Color.hex(_topBorderColor,);
  }
  ...
  set bottomBorderColor(String value) {
    ...
    _bottomBorderColorRgb = Color.hex(
        _bottomBorderColor,);
  }
  ...
  set rightBorderColor(String value) {
    ...
    _rightBorderColorRgb = Color.hex(
        _rightBorderColor,);
  }
  ...
  set backColorRgb(Color value) {
    _backColorRgb = value;
    _backColor = _backColorRgb.toHexColor().toString().toUpperCase();
  }
  ...
  set fontColorRgb(Color value) {
    _fontColorRgb = value;
    _fontColor = _fontColorRgb.toHexColor().toString().toUpperCase();
  }
  ...
  set leftBorderColorRgb(Color value) {
    ...
    _leftBorderColor =
        _leftBorderColorRgb.toHexColor().toString().toUpperCase();
  }
  ...
  set rightBorderColorRgb(Color value) {
    ...
    _rightBorderColor =
        _rightBorderColorRgb.toHexColor().toString().toUpperCase();
  }
  ...
  set topBorderColorRgb(Color value) {
    ...
    _topBorderColor = _topBorderColorRgb.toHexColor().toString().toUpperCase();
  }
  ...
  set bottomBorderColorRgb(Color value) {
    ...
    _bottomBorderColor =
        _bottomBorderColorRgb.toHexColor().toString().toUpperCase();
  }
}
